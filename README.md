...
식단은 두 기숙사가 함께 올라오는 **메인 페이지**(`dorm.deu.ac.kr/00/0000.do`) 하단
**한 곳에서만** 가져옵니다. 한 페이지에 두 관이 나란히 있으므로 표 앞 제목
("효민생활관 식단" / "행복기숙사 식단")으로 어느 관 것인지 가려냅니다.

기숙사별 페이지(`/60/6050.do`, `/60/6051.do`)는 식단을 갖고 있지 않아 보지 않습니다.
(껍데기 표만 있고 내용은 자바스크립트가 채웁니다.)
