...
식단은 두 기숙사가 함께 올라오는 **메인 페이지**(`dorm.deu.ac.kr/00/0000.do`) 하단에서
가져옵니다. 한 페이지에 두 관이 나란히 있으므로 표 앞 제목("효민생활관 식단" /
"행복기숙사 식단")으로 어느 관 것인지 가려냅니다.
거기서 못 찾으면 기숙사별 급식 안내 페이지(`/60/6050.do`, `/60/6051.do`)를 예비로 훑습니다.
